    ...
    public:    
        ...
        void first_obstacle_control(){
            if (right_first_flag == false){
                ...
                first_steering = MIN_STEERING + 8;
                second_steering = MAX_STEERING - 8;
            ...
            switch(KUUVe_STATUS)
            {
                ...
                case STATUS_TURN:{
                    ...
                    */
                    ...
                    temp_steering_angle = (status_flag_ == false) ? first_steering : second_steering;  // 각도를 좀 줄였음.
                    ...
                    */
                    if (segment_average_y > 1.0 && status_flag_ == false)  // 조건문을 steering angle로 변경해도 될것 같기도? 혹은 거리를 감소하는 뱡항으로 해도 될것 같음.
                ...
                case STATUS_RESTORE:{
                    ...
                    wayPoint.y = wayPoint.y/(count_seg_2*1.5);
                    ...
                    */
                    ...
                    if (wayPoint.x > 5 && status_flag_ == false) { // TODO 여기에 raw_obastacle의 x값을 넣어도 될것 같음 일단 테스트 해봐야함.
                ...
                case STATUS_GO_NEXT:{
                    ...
                    acker_data.drive.steering_angle = calSteeringAngle(nearest_segment_center_point_)/4;
